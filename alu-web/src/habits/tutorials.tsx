...
const introSlides = [
  ...
  (<>
    ...
    <br />
    <p>Everything from studying, to procrastinating, to brushing your teeth can be a habit</p>
  </>),
  (<>
    <h1>What is <em>Habits?</em></h1>
    <p>Alu's <em>Habits</em> is a system based on behavioral-psychology that makes building good habits and breaking bad habits easier</p>
  ...
  (<>
    ...
    <p>Your habits are personal information about yourself that you will be sharing with Alu</p>
    <p>This information will absolutely never be looked at by anyone, nor will it ever be given to any third parties*</p>
    <p>You can review our <a href='/legal/privacy-policy/'>Privacy Policy</a> for more information</p>
    <small className='text-secondary'>*Unless you specifically request we do so, or we are required by law</small>
    <br />
  </>),
  (<>
    <h1>Get Started?</h1>
    ...
    <hr />
    <p><strong>Note: <em>Habits</em> is still in Beta!  It is better than nothing but there are still plenty of improvements to be made!</strong></p>
  </>),
];
