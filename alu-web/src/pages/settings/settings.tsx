    ...
    apiProfileSettingsUpdate(
      {
        ...
        target_num_cards: form.elements.targetNumReviews.value,
    ...
    <Container className="mt-5">
      ...
      <Form onSubmit={handleSubmit}>
        <Form.Group>
          ...
          <ul>
            <li>
              <a href="/settings/change-email/">Change email</a>
            </li>
            <li>
        ...
        <Form.Group>
          <FormCheckbox
            name="sendReminders"
            defaultChecked={profile.settings.send_reminders}
          >
        ...
        <Form.Group>
          ...
          >
            ...
            <option value="MIXED">
              Mixed (can create and join classrooms)
            </option>
          </Form.Control>
        </Form.Group>
        <Form.Group>
        ...
        <Form.Group>
          <FormCheckbox
            name="sendMarketingResearch"
            defaultChecked={profile.settings.send_marketing_research}
          >
