export function errorHandler(response: any, status: number, errorCode: number) {
  if (status === 403) {
...
8014: Error creating new assignment through apiCreateAssignment
8015: Error getting assignments for teacher through apiTeacherAssignmentsList
8016: Error editing assignment through apiEditAssignment
8017: Error deleting assignment through apiDeleteAssignment
8018: Error getting student classroom-assignments list through apiStudentAssignmentsList
