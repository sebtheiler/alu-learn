...
export default function ImageResizer({
  ...
  imageParentRef: { current: null | HTMLDivElement };
  maxWidth?: number;
  ...
  const handlePointerDown = (
    ...
    if (image !== null && imageParent !== null && controlWrapper !== null) {
      ...
      imageParent.style.width = `${width}px`;
  ...
  const handlePointerMove = (event: PointerEvent) => {
    ...
    if (image !== null && imageParent !== null && positioning.isResizing) {
      // Corner cursor
