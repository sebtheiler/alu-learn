...
export default function ProUpgradePage({
  ...
  const purchase = (purchaseType: 'monthly' | 'yearly') => {
    ...
    //   );
    // }
    return async () => {console.log(purchaseType)};
  }
  ...
  return (
    <div className='container mx-auto px-20 mt-28 max-w-6xl'>
      <div className='prose text-center mx-auto'>
        ...
        {proTrialExpires && <p className='mt-0'>
          Your free-trial of Alu Pro ends in <strong>{expiresInDays} days.</strong>
        ...
        <div className='pro-card pro-card-basic'>
          ...
          <div className='pro-card-body'>
            <ul>
              ...
              <li className='xmark'><FontAwesomeIcon icon={faXmark} />No ads</li>
              <li className='xmark'><FontAwesomeIcon icon={faXmark} />Study with games</li>
              <li className='xmark'><FontAwesomeIcon icon={faXmark} />Identify difficult flashcards and topics</li>
              <li className='xmark'><FontAwesomeIcon icon={faXmark} />Create links between flashcards</li>
              <li className='xmark'><FontAwesomeIcon icon={faXmark} />Unlimited flashcards</li>
            </ul>
          </div>
        </div>
        <ProFeaturesCard />
      ...
      <div className='mt-8 text-center'>
        <div className='text-center w-100'>
          {!isLoggedIn ? <>
            <Button onClick={() => setSignUpModalOpen(true)} block>Get Started</Button>
          </> : <>
            <AsyncButton onClick={purchase('monthly')} block>Upgrade to Pro ($3/mo)</AsyncButton>
            <AsyncButton onClick={purchase('yearly')} block className='mt-2'>Upgrade to Pro ($30/yr)</AsyncButton>
          </>}
        </div>
      </div>
    </div>
