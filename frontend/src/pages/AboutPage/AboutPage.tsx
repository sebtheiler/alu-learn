    ...
    <>
      ...
      <article className="container prose mx-auto mt-28 max-w-4xl prose-a:text-blue-500 prose-a:no-underline">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto">
            By using spaced repetition, Alu enables you to turn your memory into
            a steel trap and to choose what you want to remember
          </p>
        </div>
        <hr className="my-4" />
        ...
        <div>
          ...
          <p>
            ...
            between when you study material. Alu&apos;s sharing system also
            allows you to collaborate with others on a deck, so that you
            don&apos;t need to make flashcards all by yourself. Some{" "}
          ...
          <p>
            ...
            lessons. Think of it like a Wikipedia designed to teach you in the
            way you learn best, that also includes studying features like spaced
        ...
        <div className="mt-2 grid grid-cols-1 md:grid-cols-2">
          <div>
            ...
            <p>
              Alu does this through <em>spaced repetition</em>. Spaced
              repetition is the process of studying material over spread-out
              intervals, rather than all at once. This is both more efficient
              and more effective than cramming. Alu uses spaced repetition by
              showing you the flashcards you remember better less often, and the
              flashcards you struggle with more often.
            </p>
            <p>
        ...
        <div className="mt-2 mb-5 grid grid-cols-1 md:grid-cols-5">
          <div className="md:col-span-3">
            ...
            <p>
              In the fall of 2020, when I returned to school, I realized how
              much potential Alu had in helping my classmates and I do well in
              our classes&#8212;especially on AP&reg; exams. I worked to make
