...
import sebastianUrl from 'assets/sebastian.jpg';
...
export default function AboutPage({ isLoggedIn }: AboutPageProps) {
  ...
  return (
    <article className='container prose prose-a:no-underline prose-a:text-blue-500 mx-auto max-w-4xl mt-28'>
      <h1 className='text-center mx-auto mb-2 text-4xl font-bold'>Make Memory a Choice.</h1>
      <div className='text-center'>
        <h3 className='mx-auto mb-1 text-xl font-semibold'>Alu allows you to learn anything and remember everything</h3>
        <p className='mx-auto'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-5 mt-2 mb-5'>
        <div className='md:col-span-3'>
          ...
          {!isLoggedIn && <>
            ...
            <div>
              <Button className='mt-1' onClick={() => setSignUpModalOpen(true)} block>
        ...
        <div className='md:col-span-2'>
          ...
          <div className='w-full'>
            ...
            <div className='mx-2 border-2 border-gray-400 bg-gray-100 rounded-xl
                            px-4 py-3 grid grid-cols-3 text-center'>
              <div className='flex items-center'>
                <a href='https://twitter.com/seb_theiler' target='_blank' rel='noreferrer' className='mx-auto hover:scale-125 transition'>
                  {/* https://github.com/johan/svg-cleanups/blob/master/logos/twitter.svg */}
                  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 335 276' fill='#3ba9ee' className='w-10'>
              ...
              <div className='flex items-center'>
                <a href='https://github.com/sebtheiler' target='_blank' rel='noreferrer' className='mx-auto hover:scale-125 transition'>
                  {/* https://iconmonstr.com/github-1-svg/ */}
                  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='#21252B' className='w-10'>
              ...
              <div className='flex items-center'>
                <a href='https://medium.com/@sebastiankt9' target='_blank' rel='noreferrer' className='mx-auto hover:scale-125 transition'>
                  {/* https://markentier.tech/posts/2020/10/medium-icon-svg/ */}
                  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1770 1000' className='w-14'>
                    <circle cx='500' cy='500' r='500'/> <ellipse ry='475' rx='250' cy='501' cx='1296'/> <ellipse cx='1682' cy='502' rx='88' ry='424'/>
                  </svg>
                </a>
              </div>
            </div>
