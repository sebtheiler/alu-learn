  ...
  return (
    <div className={className + ' relative border-2 border-gray-200 ' + (pill ? 'rounded-full' : 'rounded')}>
      <input
        ...
        id={id}
        name={name}
        className='block p-3 w-full text-sm text-gray-900 bg-transparent
      ...
      <label
        htmlFor={id}
        className='absolute text-sm text-gray-500 duration-200 pointer-events-none cursor-text rounded
