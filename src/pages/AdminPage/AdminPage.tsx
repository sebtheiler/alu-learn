      ...
      <div className="mt-28">
        ...
        <div className="mx-auto max-w-4xl px-5">
          ...
          <div>
            ...
            <p>Amount of time spent today: {timeStudiedToday}</p>
            <p>Amount of time spent in the past week: {timeStudiedThisWeek}</p>
            <p>Number of flashcards created in the past week: TODO</p>
