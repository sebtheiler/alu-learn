import { ClozeColor, clozeColorMap } from "./colors";
...
export class ClozeDeletionNode extends ElementNode {
  ...
  createDOM(config: EditorConfig): HTMLElement {
    ...
    addClassNamesToElement(
      ...
      this.__color !== "BLANK"
        ...
        : config.theme.clozeDeletionBlank,
      clozeColorMap.get(this.__color)
    );
    return element;
  }
  ...
  updateDOM(prevNode: ClozeDeletionNode, span: HTMLSpanElement): boolean {
    ...
    if (color !== prevNode.__color) {
      ...
      removeClassNamesFromElement(span, clozeColorMap.get(prevNode.__color));
      addClassNamesToElement(span, clozeColorMap.get(color));
    }
